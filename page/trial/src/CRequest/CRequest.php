...
*/
  public function Init($baseUrl = null, $routing=null, $lock=null, $labels=null, $new=null ) {
	...
	$this->arguments = $arguments;
		...
		if ( isset($lock['hasRoleAdmin'])|| $start!='true'  ) {
			...
			if( $labels == 'true'  )	{
				...
				if( $controller == 'module' ) {
					...
					$this->controller = 'index'; $this->method = 'index';
					
					foreach ( $arguments as $i => $value ) { unset($arguments[$i]);}
			...
			if( $controller == 'module' || $controller == 'index' ) {
			
				$this->controller = 'lingon'; $this->method = 'index';
			...
			if( $controller == 'page'|| $controller == 'guestbook' ) {
				
				
				if( $controller == 'page'&& $method == 'view' ) {
					
					$this->controller = 'page'; $this->method = 'view';
				...
				$this->controller = 'user'; $this->method = 'index';
			...
			if( $controller == 'blog') {
				...
				$this->controller = 'lingon'; $this->method = 'blog';
			...
			if( $controller == 'developer'|| $controller == 'acp') {
