 ...
 /**
   ...
   /**
        ...
        protected function __construct() {
			...
			//if( $_SERVER["REQUEST_URI"]=="/slutprojekt/triload/trial/lingon" ){$this->a='tre';}
			
			//if( $_SERVER["REQUEST_URI"]=="/slutprojekt/triload/trial/lingon/blog" ){$this->a='tre';}

			//if( $_SERVER["REQUEST_URI"]=="/slutprojekt/triload/trial/lingon/guestbook" ){$this->a='tre';}
    ...
    require(LYDIA_SITE_PATH.'/config.php');
	    ...
	    //require(LYDIA_SITE_PATH.'/themes/lingon/config.php');
		...
		/*
		if (!isset($this->user->profile['hasRoleUser'])) {
    
			echo var_dump($this->user->profile['hasRoleUser']);
		}
		*/
...
/**
  	...
  	public function FrontControllerRoute() {
		...
		if(isset($this->config['start'])){$new=$this->config['start'];}
		else{$new='true';}
		
    	$this->request->Init($this->config['base_url'], $this->config['routing'], $this->user->profile, $this->config['installed'],$new );
