...
/**
* To disable administrator to create new labels.
* labels installed put value $Origo->config['start']= 'true';
*/
...
/**
* To disable administrator to create new labels.
* labels installed put value $Origo->config['installed']= 'true';
*/

		$Origo->config['installed'] = 'false';
 ...
 */
	...
	'lingon'        => array('enabled' => true,'class' => 'CClingon', 'a'=>'1'),
...
*/
	...
	'user' => array('label'=>'Info', 'url'=>'lingon/info'),
	'doc' => array('label'=>'dok', 'url'=>'lingon/dok'),
 ...
 */
	...
	'menu_to_region' => array('lingon'=>'navbar'),
	'data' => array(
    'header' => 'Page',
